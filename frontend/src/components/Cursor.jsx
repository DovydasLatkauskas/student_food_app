...
export const Cursor = () => {
	...
	return (
		<>
			<div style={{pointerEvents: "none", transition: "width 0.4s, height 0.4s"}} ref={cursorSlow} className={"mix-blend-difference rounded-full " + (linkOver ? "h-0 w-0" : "h-16 w-16") + " border-solid border-2 z-50 absolute cursor"} >
			</div>
